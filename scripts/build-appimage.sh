...
mkdir -p "$appdir_path/usr/lib/superhuman" || exit 1
cp "$script_dir/launcher-common.sh" "$appdir_path/usr/lib/superhuman/" || exit 1
...
source "$appdir/usr/lib/superhuman/launcher-common.sh"
...
<component type="desktop-application">
  ...
  <summary>The fastest email experience ever made - Linux port</summary>

  <description>
    <p>
      Superhuman is a premium email client designed for speed and productivity.
      This package provides Superhuman for Linux, repackaged from the official Windows version.
    </p>
  </description>
  ...
  <url type="homepage">https://github.com/aaddrick/superhuman-linux</url>
